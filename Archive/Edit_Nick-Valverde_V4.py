...
particle_energy = 2*kV
velocity = np.sqrt(2.*particle_energy*echarge/uranium_beam.mass)*1.178 #get particles that defocus to focus together at the axis. 1.22 top particle escapes. 1.19 good value. Above 1.18
#uranium_beam.addparticles(x=0., y=0., z =0., vx = 0., vy=0., vz= velocity*1.025)
#uranium_beam.addparticles(x=0., y=0., z =0., vx = 0., vy=0., vz= velocity*1.020)
#uranium_beam.addparticles(x=0., y=0., z =0., vx = 0., vy=0., vz= velocity*1.015)
#uranium_beam.addparticles(x=0., y=0., z =0., vx = 0., vy=0., vz= velocity*1.010)
#uranium_beam.addparticles(x=0., y=0., z =0., vx = 0., vy=0., vz= velocity*1.05)
#uranium_beam.addparticles(x=0., y=0., z =0., vx = 0., vy=0., vz= velocity*1.00)
#uranium_beam.addparticles(x=0., y=0., z =0., vx = 0., vy=0., vz= velocity*0.995)
#uranium_beam.addparticles(x=0., y=0., z =0., vx = 0., vy=0., vz= velocity*0.990)
#uranium_beam.addparticles(x=0., y=0., z =0., vx = 0., vy=0., vz= velocity*0.985)
#uranium_beam.addparticles(x=0., y=0., z =0., vx = 0., vy=0., vz= velocity*0.980)
#uranium_beam.addparticles(x=0., y=0., z =0., vx = 0., vy=0., vz= velocity*0.975)
