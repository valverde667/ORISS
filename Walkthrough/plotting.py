...
data = pd.read_csv('/Users/nickvalverde/Dropbox/Research/ORISS/Walkthrough/trajectoryfile.txt', names = column_names)
...
plt.savefig('/Users/nickvalverde/Dropbox/Research/ORISS/Walkthrough/Runs_plots/z-trajectory.png', dpi=300)
...
fig, ax = plt.subplots(figsize = (7,7))
for i in range(len(copy['Particle'].unique())):
    df_xp = copy[data['Particle'] == i] #Create a seperate data fram for plotting xp specifics.
...
plt.savefig('/Users/nickvalverde/Dropbox/Research/ORISS/Walkthrough/Runs_plots/x-trajectory.png', dpi=300)
...
plt.savefig('/Users/nickvalverde/Dropbox/Research/ORISS/Walkthrough/Runs_plots/rms_x.png', dpi=300)
...
plt.savefig('/Users/nickvalverde/Dropbox/Research/ORISS/Walkthrough/Runs_plots/rms_z.png', dpi=300)
