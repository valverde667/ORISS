...
zsrf = [-.04499*mm,0.0*mm,.04499*mm]  # downstream, upstream z-extent ring
rsrf = [0.071*mm,0.025*mm,.071*mm] #coordinates for creating cone of revolution
...
velocity = np.sqrt(2.*particle_energy*jperev/uranium_beam.mass)
#--Point to point load
# =============================================================================
# uranium_beam.addparticles(x=-.000, y=0., z =0., vx = 0., vy=0., vz= 1.005*velocity)
# uranium_beam.addparticles(x=-.000, y=0., z =0., vx = 0., vy=0., vz= 1.004*velocity)
# uranium_beam.addparticles(x=-0.000, y=0., z =0., vx = 0., vy=0., vz= 1.003*velocity)
# uranium_beam.addparticles(x=-0.000, y=0., z =0., vx = 0., vy=0., vz= 1.002*velocity)
# uranium_beam.addparticles(x=-0.000, y=0., z =0., vx = 0., vy=0., vz= 1.001*velocity)
# uranium_beam.addparticles(x=0., y=0., z =0., vx = 0., vy=0., vz= velocity)
# uranium_beam.addparticles(x=0.000, y=0., z =0., vx = 0., vy=0., vz= -.999*velocity)
# uranium_beam.addparticles(x=0.000, y=0., z =0., vx = 0., vy=0., vz= -.998*velocity)
# uranium_beam.addparticles(x=0.000, y=0., z =0., vx = 0., vy=0., vz= -.997*velocity)
# uranium_beam.addparticles(x=0.000, y=0., z =0., vx = 0., vy=0., vz= -.996*velocity)
# uranium_beam.addparticles(x=0.000, y=0., z =0., vx = 0., vy=0., vz= -.995*velocity)
# =============================================================================
