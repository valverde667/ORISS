...
velocity = np.sqrt(2.*particle_energy*echarge/beam00.mass)
beam00.addparticles(x=0., y=0., z =0., vx = 0., vy=0., vz= velocity)
...
for iteration in range(1,2066*10):
 ...
 print("beam velocity is: ", beam00.getvz())
 print("beam energy is: ", beam00.ekin)
